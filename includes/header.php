<?php 
    ...
    require dirname(dirname(__FILE__)) . "/includes/dbconfig.php";
    ...
    if(isset($_SESSION['username'])){
        ...
        $number = "SELECT COUNT(*) as num_products FROM cart WHERE user_id = '$user_id'";
        $numberQuery = mysqli_query($conn,$number);

        $getNumber = mysqli_fetch_assoc($numberQuery);
    }
...
<html lang="en">
  <head>
    ...
    <link href="http://localhost/ecommerce/assets/bootstrap.min.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container" style="margin-top: none">
        <a class="navbar-brand  text-white" href="<?php echo APPURL?>">Ecommerce</a>
